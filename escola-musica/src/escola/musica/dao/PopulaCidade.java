...
public class PopulaCidade {
	...
	public static void main(String[] args) {
		...
		Cidade cidadeSp3 = new Cidade("Jacaré", Estado.SP);
		...
		Cidade cidadeMg5 = new Cidade("Trás Corações", Estado.MG);
